  ...
  return (
    <div className={q.formBox}>
      <div className={q.innerBox}>
        <form className={q.form} method="post" action="mailto:savkamaryana@ukr.net">
          ...
          <div className={q.email + " " + q.formField}>
            ...
            <div className={q.input}>
            <input type="email" name="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" title="Invalid email address" required />
            </div>
          </div>
